...
<form  method="post" class="clearfix" action="<?php echo site_url('User/welcome'); ?>">
<div class="input-field clearfix">
<div class="col-md-6">
<input type="text" id="registration_primaryGuest_firstName" name="usr_fname" required="required" placeholder="First Name" class="form-control form-control" />
</div>
<div class="col-md-6">
<input type="text" id="registration_primaryGuest_lastName" name="usr_lname" required="required" placeholder="Last Name" class="form-control form-control" />
</div>
</div>
<div class="input-field clearfix">
<div class="col-md-6">
<input type="email" id="registration_primaryGuest_email" name="usr_email" required="required" placeholder="Email" class="form-control form-control" />
</div>
<div class="col-md-6">
<input type="text" id="registration_primaryGuest_zipCode" name="usr_zip_code" class="form-control zipcode-input form-control" placeholder="Zip Code" size="5" maxLength="5" maxlength="5" minlength="5" />
</div>
</div>
<div class="input-field clearfix">
<div class="col-md-6">
<select id="registration_noOfGuests" name="usr_no_guest" placeholder="No. of Guests" class="form-control form-control"><option value="">No. of Guests</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option></select>
</div>
</div>
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" id="registration_primaryGuest_subscriptions_saluteMilitaryAppreciationClub" name="saluteMilitaryAppreciationClub" value="1" />
